...
const ProductDetails = () => {
  ...
  // Extract category title from fetched data
  ...
  return (
    <div className='mb-16 pt-44 lg:pt-[30px] xl:pt-0'>
      <div className='container mx-auto'>
        ...
        <RelatedProducts categoryTitle={categoryTitle} currentProductId={id} />
      </div >
    </div >
  );
};
